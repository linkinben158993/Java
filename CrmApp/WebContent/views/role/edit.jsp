...
<div class="container-fluid">
	...
	<div class="row">
		...
		<div class="col-md-8 col-xs-12">
			<div class="white-box">
				<form class="form-horizontal form-material" action="<c:url value="/admin/role/edit"/>" method="post">
					...
					<div class="form-group">
						<div class="col-sm-12">
							...
							<a href="<c:url value="${UrlConstants.USER_ROLE_LIST}" />" class="btn btn-primary">Quay lại</a>
						</div>
					</div>
				</form>
			</div>
